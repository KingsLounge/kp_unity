...
public class CafeManageMemberTemplate : MonoBehaviour
{
    public Text userIdText;
    public Image muteImage;
    public Text permitText;
    private CAFE_MEMBER_PERMIT permit;
    private CustomUiCafeManageMembers module;
    ...
    public void SetData(CustomUiCafeManageMembers module, JObject d)
    {
        ...
        permitText.text = permit.ToString();
    }
    ...
    public void OnClickChangePermitButton()
    {
        ...
        if (permit == CAFE_MEMBER_PERMIT.member) newPermit = CAFE_MEMBER_PERMIT.manager;
        if (permit == CAFE_MEMBER_PERMIT.manager) newPermit = CAFE_MEMBER_PERMIT.member;
