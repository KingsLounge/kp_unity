...
public class CustomUiCafeManageMembers : CustomUIWebSocket
{
    ...
    private List<CafeManageMemberTemplate> templates = new List<CafeManageMemberTemplate>();
    ...
    private void Awake()
    {
        ...
        {
            CafeManageMemberTemplate t = go.GetComponent<CafeManageMemberTemplate>();
