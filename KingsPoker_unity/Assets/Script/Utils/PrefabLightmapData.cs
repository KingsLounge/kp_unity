...
//			{
//				UnityEditor.Prefab
//				UnityEditor.PrefabUtility.SaveAsPrefabAsset(gameObject, UnityEditor.AssetDatabase.GetAssetPath(targetPrefab));
//			}
//		}
//	}
...
public class PrefabLightmapData : MonoBehaviour
{
    ...
    public void setRendererInfo(List<RendererInfo> data)
    {
        m_RendererInfo = data.ToArray();
    }
