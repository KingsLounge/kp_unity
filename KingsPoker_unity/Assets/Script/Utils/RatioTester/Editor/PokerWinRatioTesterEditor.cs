...
using UnityEngine;
public class PokerWinRatioTesterEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        PokerWinRatioTester tester = (PokerWinRatioTester)target;
        ...
        if (GUILayout.Button("테스트", GUILayout.Width(120), GUILayout.Height(30)))
        {
            tester.ShowPokerOddsRatio(); 
        }
