...
Shader "Rora/Transparent/Uvscroll_Illum_blend" {
Properties {
	...
	_IllumPower ("Rim Power", Range(0,4.0)) = 1.0
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	fixed4 maskD = tex2D(_UvscrollMask,fixed2(IN.uv_MainTex.x - _Time.x*TimeSpeed, IN.uv_MainTex.y));
